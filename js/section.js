...
//NOTE TO SELF: FIX CLASS WHY IS IT WEIRD FONT ON TEXT TOO I JUST WANT ARROWS :( :( :(
function nextSection() {
  $("#prev-section").addClass('fa-solid fa-chevron-left');
  $("#prev-section").text('Prev');
  $("#next-section").addClass('fa-solid fa-chevron-right');
  $("#next-section").text('Next >');
  sectionNum = sectionNum + 1 >= numSections ? 0 : sectionNum + 1;
  if(sectionNum == numSections - 1){
    $("#next-section").addClass('fa-solid fa-chevron-right');
    $("#next-section").text('Start');
  }
  if(sectionNum == 0){
    $("#prev-section").addClass('fa-solid fa-chevron-left');
    $("#prev-section").text('Sheet');
  }
  updateSection();
}
